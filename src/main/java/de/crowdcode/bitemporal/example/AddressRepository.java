...
public class AddressRepository {
	...
	public Collection<AddressImpl> findByPersonIdAndValidity(Long personId, Date validDate) {
		Query query = em.createQuery(
				"select c from AddressImpl c where " + "c.validFrom <= :validDate and " + "c.person.id = :personId");
